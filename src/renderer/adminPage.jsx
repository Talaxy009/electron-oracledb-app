...
function StudentPanel(props) {
  ...
  const RefreshData = (i) => {
    if (i) {
      ...
      ipcRenderer.once("gotData", (_event, result) => {
        setValues({
          ...values,
          summaryC: formatMetaData(result.metaData),
          summaryR: result.rows,
        });
        //console.log("gotData");
      });
    } else {
  ...
  const changeGrade = (line) => (event) => {
    ...
    setValues({
      ...values,
      grade: values.grade.map((item, _line) =>
        _line == line ? { ...item, [2]: setG } : item
      ),
    });
  };
        ...
        <Grid container spacing={4}>
                ...
                <Table aria-label={index}>
                  ...
                  <TableBody>
                    ...
                    <TableRow className={classes.inputrow}>
                      ...
                      <TableCell align="center">
                        {values.editMod ? (
                          <Button onClick={editDone} variant="outlined">
                            完成
                          </Button>
                        ) : (
                          <Button onClick={addDone} variant="outlined">
                            添加
                          </Button>
                        )}
                      </TableCell>
              ...
              <OutlinedInput
                ...
                endAdornment={
                  <InputAdornment position="end">
                    <IconButton id="search" onClick={searchStudent}>
                      <SearchRoundedIcon />
                    </IconButton>
                  </InputAdornment>
                }
              ...
              <Table aria-label={index}>
                ...
                <TableBody>
                  <TableRow>
                    ...
                    <TableCell align="center">
                      <Button onClick={inDone} variant="outlined">
                        完成
                      </Button>
                    </TableCell>
                  </TableRow>
          ...
          <Grid item xs={12}>
            <div style={{ display: "flex" }}>
              ...
              <IconButton onClick={() => RefreshData(1)} style={{ height: 48 }}>
                <RefreshRoundedIcon />
              </IconButton>
            </div>
            <hr />
